export const projects = [
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Results",
        paragraphs: [
          "The 2022 Mauna Loa eruption produced a lava flow approximately 19 km in length that traveled northeast from the summit rift, crossing the Mauna Loa Weather Observatory access road before stopping 2.8 km short of the Daniel K. Inouye Highway (Saddle Road). The eruption covered approximately 31 km2 and was the first by Mauna Loa in 38 years. Although USGS Lava-Flow Hazard Zones 1-3 collectively encompass roughly 22% of Hawaii Island's area, the 2022 flow intersected only conservation-zoned land, with no damage to urban or rural infrastructure. Approximately 45,000 residents, about 23% of the Big Island's population, live within Zones 1-2, along with portions of the Saddle Road, power lines, and larger population centers such as Hilo.",
          "The May 18, 1980, Mount St. Helens eruption, triggered by a magnitude 5+ earthquake that released a massive flank collapse and lateral blast, was rated VEI 5. Pyroclastic and debris avalanches scoured approximately 57 km2 around the crater, while lahars inundated 16 km2 of downstream floodplain in the North Fork Toutle and Muddy River valleys. Ashfall blanketed over 57,000 km2 across Washington, Oregon, and Idaho, depositing 1 cm or more of ash across roughly 22,000 mi2. Approximately 12,000 people reside within the combined pyroclastic-flow and lahar zones, with an additional estimated 650,000 at risk of receiving significant ashfall in a comparable future eruption. Critical transportation infrastructure, including the I-5 corridor, Spirit Lake Highway, and freight rail, falls within high-ashfall zones.",
    ...
    figures: [
      ["figs/shieldfig1.jpg", "Figure 1: Georeferenced U.S. Forest Service Pacific Northwest Research Station post-eruption map of the May 18, 1980, Mount St. Helens eruption, showing lateral blast, pyroclastic-flow, and lahar disturbance zones against a DEM of the Cascade Range. Red points indicate the locations of all 57 confirmed fatalities.", true],
      ["figs/shieldfig2.jpg", "Figure 2: USGS Lava-Flow Hazard Zones (Zones 1-9) for Hawaii Island, with Zone 1 representing the highest hazard (above), and the footprint of the November 27-December 10, 2022, Mauna Loa eruption overlaid on Hawaii State infrastructure zoning classes (below).", false],
      ["figs/shieldfig3.jpg", "Figure 3: FEMA National Risk Index (NRI) volcanic hazard scores by census tract for Hawaii Island (left) and Washington State (right), on a 0-100 scale. Hawaii tracts score below 50 throughout; Washington tracts within pyroclastic-flow and lahar zones reach scores into the 90s.", false]
    ]
  },
  {
    ...
    figures: [
      ["figs/mineralfig1.jpg", "Figure 1: Combined LNDI, UNDI, and DEM spectral index map of New Caledonia (left) alongside a true-color Sentinel-2 image (right). Warmer colors indicate higher predicted Co-Ni likelihood; red circles mark known mining operations.", true],
      ["figs/mineralfig2.jpg", "Figure 2: Random Forest classification output for New Caledonia (left) alongside a true-color Sentinel-2 image (right). Dark green = forest; green = herbaceous; yellow = development/barren; red = predicted Co-Ni deposit. Red circles mark known mining operations.", false],
      ["figs/mineralfig3.jpg", "Figure 3: Composite map produced by overlaying the Random Forest classification onto the spectral indices map, with red indicating predicted Co-Ni regions. Stronger red signals reflect areas flagged by both methods.", false]
    ]
  },
  {
    slug: "vog-exposure",
    ...
    sections: [
      {
        heading: "Background",
        paragraphs: [
          "This project addresses the public-health concern in Hawai'i of the uneven spatial impact of volcanic smog, or vog, produced during eruptive activity at Kilauea. Vog forms when sulfur dioxide (SO2) and fine particulate matter (PM2.5; particles less than 2.5 microns in diameter) released by volcanic activity accumulate and react in the atmosphere, creating air pollution that can aggravate asthma, chronic obstructive pulmonary disease (COPD), and other respiratory illnesses. Because vog exposure varies by location depending on eruption intensity, wind patterns, and distance from the volcano, some communities may face greater health risk than others.",
          "The objective of this study was to identify where elevated vog exposure and underlying respiratory vulnerability overlap across Hawai'i census tracts during an active eruptive period from October 1st to December 1st of 2025, with the broader goal of highlighting communities where public-health preparedness and risk communication may be most needed."
        ]
      },
      {
        heading: "Data and Materials",
        paragraphs: [
          "The analysis combines environmental monitoring data with tract-level health data and census geography. Hourly SO2 and PM2.5 measurements for the period from October 1 to December 1 of 2025 were obtained from the Hawai'i Department of Health Clean Air Branch in table form, and these station-based observations were used to derive a pollution exposure metric based on the number of hours above high-pollution thresholds.",
          "Census tracts from 2020 were used as the geographic unit for vulnerability and risk mapping, and tract-level estimates of adult asthma prevalence and adult COPD prevalence from 2017-2022 were compiled from the Hawai'i Health Data Warehouse and joined to tract polygons. To support valid spatial analysis, all datasets were projected into NAD 1983 HARN UTM Zone 5N, allowing distance-based tools such as kernel density estimation and nearest-neighbor analysis to operate in consistent map units. This dataset design is appropriate because it links hazard, health vulnerability, and geography into a single analytical framework."
        ]
      },
      {
        heading: "Methods",
      ...
      },
      {
        heading: "Results",
        paragraphs: [
          "The results show that vog-related respiratory risk was not distributed randomly across Hawai'i. The KDE surface indicated the greatest relative exposure intensity near Kilauea and across the southern portion of the Big Island, while lower modeled exposure occurred farther from the main emission source.",
    ...
    figures: [
      ["figs/vogfig1.png", "Figure 1: Kernel density estimation (KDE) surface of vog exposure intensity across the Hawaiian Island chain, derived from monitoring station counts of hours above high-pollution thresholds using a 90 km search radius. Highest estimated exposure is concentrated near the Kilauea eruption site on the southern Big Island.", true],
      ["figs/vogfig2.png", "Figure 2: Getis-Ord Gi* hot-spot analysis of the composite Vog Risk Index by census tract, with statistical confidence levels of 90%, 95%, and 99%. Significant hot spots of elevated respiratory risk are concentrated along the southern Big Island; no significant hot spots are identified in other parts of the state.", true],
      ["figs/vogfig3.jpg", "Figure 3: Local Moran's I (LISA) cluster map of the Vog Risk Index by census tract across Hawai'i. High-high clusters are concentrated in the southern Big Island in proximity to Kilauea, while low-low clusters appear near Honolulu. High-low and low-high outliers indicate tracts whose risk values diverge from their spatial neighbors.", false],
      ["figs/vogfig4.jpg", "Figure 4: Moran's scatterplot for the Local Moran's I analysis of the Vog Risk Index, with z-transformed risk values on the x-axis and their spatial lag on the y-axis (R2 = 0.31). Points in the upper-right and lower-left quadrants correspond to high-high and low-low clusters respectively; points in the remaining quadrants represent spatial outliers.", false]
    ]
  },
  {
    slug: "brooks-range",
    ...
    figures: [["figs/characterfig1.jpg", "Figure 1: Shaded relief map of the study area west of the Dalton Highway, central Brooks Range, Alaska. Green circles mark the six detrital zircon sample locations; structural measurements are shown by the symbols in the legend. Inset shows location within Alaska.", true]],
    references: [
  ...
  },
  {
    ...
    figures: [
      ["figs/impactfig1.jpg", "Figure 1: Map of abnormal rainfall on the Big Island of Hawaii along with the extent of tephra and magma from the 2018 Kilauea eruption.", true],
      ["figs/impactfig2a.png", "Figure 2a: Map of pollution recorded before the 2018 Kilauea eruption from USGS monitoring stations across the inhabited islands of Hawaii, including the extent of the magma released.", false],
      ["figs/impactfig2b.png", "Figure 2b: Map of pollution recorded during the 2018 Kilauea eruption from USGS monitoring stations across the inhabited islands of Hawaii, including the extent of the magma released.", false],
      ["figs/impactfig2c.png", "Figure 2c: Map of pollution recorded post-eruption from USGS monitoring stations across the inhabited islands of Hawaii, including the extent of the magma released.", false],
      ["figs/impactfig3.jpg", "Figure 3: Map of eruption and tephra extent and local marine habitat to highlight potential direct ecological effects of the eruption.", true]
    ]
  }
];
